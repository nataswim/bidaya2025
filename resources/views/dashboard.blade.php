                        ...
                        <div class="d-flex align-items-center p-4 {{ !$loop->last ? 'border-bottom' : '' }}">
                            ...
                            <div class="flex-fill">
                                ...
                                <div class="d-flex align-items-center text-muted">
                                    <small>{{ $post->category->name ?? 'Non catégorisé' }}</small>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('public.show', $post) }}" target="_blank">Voir</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <div class="d-grid gap-3">
                        <a href="{{ route('admin.posts.create') }}" class="btn btn-primary d-flex align-items-center">
                            <i class="fas fa-plus me-2"></i>
                            <div class="text-start">
                                <div class="fw-semibold">Nouvel article</div>
                                <small class="opacity-75">Créer un article</small>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('admin.categories.create') }}" class="btn btn-outline-info d-flex align-items-center">
                            ...
                            <div class="text-start">
                                <div class="fw-semibold">Nouvelle catégorie</div>
                                <small class="opacity-75">Organiser le contenu</small>
                            </div>
                        </a>
                        
                        <a href="{{ route('admin.users.create') }}" class="btn btn-outline-success d-flex align-items-center">
