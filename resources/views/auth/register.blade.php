                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="bio" id="bio" rows="4"
                                                  class="form-control border-start-0 @error('bio') is-invalid @enderror"
                                                  placeholder="Parlez-nous de vos besoins, votre activité sportive, vos objectifs..." 
                                                  maxlength="200" required>{{ old('bio') }}</textarea>
                                        @error('bio')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
