...
@section('title', 'Créer une Sous-Catégorie de Fiche')
@section('page-title', 'Nouvelle Sous-Catégorie')
@section('page-description', 'Création d\'une nouvelle sous-catégorie de fiche')

@section('content')
<div class="container-fluid">
    <form method="POST" action="{{ route('admin.fiches-sous-categories.store') }}">
        @csrf
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="4"
                                      class="form-control"
                                      placeholder="Description détaillée de la sous-catégorie...">{{ old('description') }}</textarea>
                        </div>
