...
@section('title', 'Gestion des Catégories de Vidéos')
@section('page-title', 'Catégories de Vidéos')
@section('page-description', 'Gestion des catégories de vidéos')
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-gradient-primary text-white p-4">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.video-categories.create') }}" class="btn btn-light">
            ...
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="border-0 py-3 text-center">Vidéos</th>
                        ...
                        <tr>
                            ...
                            <td class="py-3 text-center">
                                <div class="d-flex flex-column align-items-center">
                                    <span class="fw-bold {{ $category->videos_count > 0 ? 'text-primary' : 'text-muted' }}">
                                        {{ $category->videos_count }}
                                    </span>
                                    @if($category->videos_count > 0)
                                        <a href="{{ route('admin.videos.index', ['category' => $category->id]) }}" 
                            ...
                            <td class="py-3 text-end">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" 
                                               href="{{ route('admin.video-categories.edit', $category) }}">
                                        ...
                                        @if($category->is_active)
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center" 
                                                   href="{{ route('public.videos.category', $category) }}" 
                                                   target="_blank">
                                        ...
                                        <li>
                                            <form method="POST" 
                                                  action="{{ route('admin.video-categories.destroy', $category) }}" 
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    @if(request('search'))
                                        <p class="mb-3">Aucun résultat ne correspond à vos critères.</p>
                                        <a href="{{ route('admin.video-categories.index') }}" class="btn btn-outline-primary">
                                            <i class="fas fa-arrow-left me-2"></i>Voir toutes les catégories
                                        </a>
                                    @else
                                        <p class="mb-3">Créez votre première catégorie</p>
