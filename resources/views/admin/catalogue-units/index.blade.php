            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-gradient-primary text-white p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.catalogue-units.create') }}" class="btn btn-light">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end shadow">
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center" 
                                                               href="{{ route('admin.catalogue-units.show', $unit) }}">
       ...
       href="{{ route('admin.catalogue-units.contents', $unit) }}">
        <i class="fas fa-list me-2 text-success"></i>Gérer les contenus
                                                        ...
                                                        @if($unit->content_url)
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center" 
                                                                   href="{{ $unit->content_url }}" 
                                                                   target="_blank">
                                                                    <i class="fas fa-external-link-alt me-2 text-success"></i>Voir le contenu
                                                                </a>
                                                            </li>
                                                        @endif
