                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="meta_description" 
                                      ...
                                      placeholder="Description courte pour les r̩sultats de recherche">{{ old('meta_description', isset($tag) ? $tag->meta_description : '') }}</textarea>
            ...
            <div class="card-body p-4">
                ...
                <div class="form-text">
                    <small class="text-muted">
                        ...
                        Les tags inactifs n'apparaissent pas dans les s̩lections
                    </small>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                ...
                <input type="text" 
                       ...
                       placeholder="Ex: Technologies, Cat̩gories">
