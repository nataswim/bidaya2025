...
@section('page-description', 'Gestion des permissions système')
                ...
                <div class="card-header bg-gradient-warning text-white p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <small class="opacity-75">{{ $permissions->total() ?? $permissions->count() }} permission(s) configurée(s)</small>
                        </div>
                    ...
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-3">
                            <select name="usage" class="form-select">
                                ...
                                <option value="used" {{ request('usage') === 'used' ? 'selected' : '' }}>Utilisées</option>
                                <option value="unused" {{ request('usage') === 'unused' ? 'selected' : '' }}>Non utilisées</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="card-body p-0">
                                                        ...
                                                        @else
                                                            ...
                                                            <li>
                                                                <span class="dropdown-item text-muted">
                                                                    <i class="fas fa-info-circle me-2"></i>Utilisée par {{ $permission->roles()->count() }} rôle(s)
                                                                </span>
                                                            </li>
                                                        @endif
                                                    </ul>
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            @else
                                <p class="text-muted mb-3">Créez vos premières permissions pour contrôler les accès</p>
        ...
        <div class="col-lg-4">
                    ...
                    <div class="row g-3 text-center">
                        ...
                        <div class="col-6">
                            <div class="bg-success bg-opacity-10 rounded p-3">
                                ...
                                <small class="text-muted">Utilisées</small>
                            </div>
                        </div>
                        <div class="col-6">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-3">
                    ...
                    @empty
                        <p class="text-muted mb-0">Aucun groupe configuré</p>
                    @endforelse
                </div>
            </div>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        @if($unusedPermissions > 0)
                            <button class="btn btn-outline-warning" onclick="showUnusedPermissions()">
                                <i class="fas fa-exclamation-triangle me-2"></i>{{ $unusedPermissions }} non utilisées
                            </button>
                        @endif
...
function exportPermissions() {
    // Simuler l'export - à implémenter dans le contrôleur
