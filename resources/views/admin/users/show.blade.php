...
@section('page-description', 'Profil et détails du compte')
                ...
                <div class="card-body p-4">
                    ...
                    <div class="border-top pt-4">
                        <h6 class="fw-semibold mb-3">
                            <i class="fas fa-chart-line me-2 text-primary"></i>Activité
                        </h6>
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="text-center p-3 bg-light rounded">
                                    <div class="fw-bold text-primary fs-4">{{ $user->posts()->count() }}</div>
                                    <small class="text-muted">Articles créés</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-center p-3 bg-light rounded">
                ...
                <div class="card-body p-3">
                    <div class="row g-3 small">
                        ...
                        <div class="col-6">
                            ...
                            @else
                                <em class="text-muted">Jamais modifié</em>
                            @endif
                        </div>
                    </div>
                </div>
