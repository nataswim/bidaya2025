...
@section('page-description', 'Modification de la catégorie : ' . $fichesCategory->name)

@section('content')
<div class="container-fluid">
    <form method="POST" action="{{ route('admin.fiches-categories.update', $fichesCategory) }}">
        @method('PUT')
        @csrf
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   name="name" 
                                   id="name" 
                                   value="{{ old('name', $fichesCategory->name) }}"
                                   class="form-control form-control-lg @error('name') is-invalid @enderror"
                                   placeholder="Ex: Exercices de natation"
                                   required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light">{{ url('/fiches') }}/</span>
                                <input type="text" 
                                       name="slug" 
                                       id="slug" 
                                       value="{{ old('slug', $fichesCategory->slug) }}"
                                       class="form-control"
                                       placeholder="exercices-natation">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="4"
                                      class="form-control"
                                      placeholder="Description détaillée de la catégorie...">{{ old('description', $fichesCategory->description) }}</textarea>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" 
                                           name="meta_title" 
                                           id="meta_title" 
                                           value="{{ old('meta_title', $fichesCategory->meta_title) }}"
                                           class="form-control">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="meta_description" 
                                              id="meta_description" 
                                              rows="3"
                                              class="form-control">{{ old('meta_description', $fichesCategory->meta_description) }}</textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" 
                                           name="meta_keywords" 
                                           id="meta_keywords" 
                                           value="{{ old('meta_keywords', $fichesCategory->meta_keywords) }}"
                                           class="form-control"
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" 
                                       ...
                                       id="is_active" 
                                       value="1"
                                       {{ old('is_active', $fichesCategory->is_active) ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="sort_order" 
                                   id="sort_order" 
                                   value="{{ old('sort_order', $fichesCategory->sort_order) }}"
                                   class="form-control"
                                   placeholder="0"
                                   min="0">
                    ...
                    <div class="card-body p-4">
                        <div class="input-group">
                            <input type="text" 
                                   name="image" 
                                   id="categoryImage"
                                   value="{{ old('image', $fichesCategory->image) }}"
                                   class="form-control"
