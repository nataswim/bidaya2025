...
@section('title', 'Créer une Section Workout')
@section('page-title', 'Nouvelle Section')
@section('page-description', 'Création d\'une nouvelle section de workout')

@section('content')
<div class="container-fluid">
    <form method="POST" action="{{ route('admin.workout-sections.store') }}">
        @csrf
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="4"
                                      class="form-control"
                                      placeholder="Description détaillée de la section...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
