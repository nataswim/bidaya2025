    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-gradient-info text-white p-4">
                <h5 class="mb-0">
                    <i class="fas fa-layer-group me-2"></i>Informations de la sous-catégorie
                </h5>
            </div>
            <div class="card-body p-4">
                <!-- Catégorie parente -->
                <div class="mb-4">
                    <label for="exercice_category_id" class="form-label fw-semibold">Catégorie parente *</label>
                    <select name="exercice_category_id" 
                        ...
                        @foreach($categories as $cat)
                            <option value="{{ $cat->id }}" 
                                {{ old('exercice_category_id', $exerciceSousCategory->exercice_category_id ?? request('category')) == $cat->id ? 'selected' : '' }}>
                                {{ $cat->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           name="name" 
                           id="name" 
                           value="{{ old('name', $exerciceSousCategory->name ?? '') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           name="slug" 
                           id="slug" 
                           value="{{ old('slug', $exerciceSousCategory->slug ?? '') }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" 
                              id="description" 
                              class="d-none @error('description') is-invalid @enderror">{{ old('description', $exerciceSousCategory->description ?? '') }}</textarea>
                              
                    <div class="form-text">Décrivez cette sous-catégorie d'exercices...</div>
                    @error('description')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           name="meta_title" 
                           id="meta_title" 
                           value="{{ old('meta_title', $exerciceSousCategory->meta_title ?? '') }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="meta_description" 
                              ...
                              placeholder="Description pour les moteurs de recherche">{{ old('meta_description', $exerciceSousCategory->meta_description ?? '') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           name="meta_keywords" 
                           id="meta_keywords" 
                           value="{{ old('meta_keywords', $exerciceSousCategory->meta_keywords ?? '') }}"
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body p-4">
                <div class="mb-3">
                    ...
                    <input type="number" 
                           name="sort_order" 
                           id="sort_order" 
                           value="{{ old('sort_order', $exerciceSousCategory->sort_order ?? 0) }}"
                ...
                <div class="form-check">
                    <input type="checkbox" 
                           ...
                           id="is_active" 
                           value="1"
                           {{ old('is_active', $exerciceSousCategory->is_active ?? true) ? 'checked' : '' }}
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-gradient-warning text-white p-4">
                <h6 class="mb-0">
                    <i class="fas fa-image me-2"></i>Image de la sous-catégorie
                </h6>
            </div>
            <div class="card-body p-4">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" 
                               name="image" 
                               id="image" 
                               value="{{ old('image', $exerciceSousCategory->image ?? '') }}"
                ...
                @if(isset($exerciceSousCategory) && $exerciceSousCategory->image)
