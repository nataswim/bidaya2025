...
<div class="container-fluid">
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-primary text-white p-4">
            <h5 class="mb-0">
                <i class="fas fa-list-ol me-2"></i>Nouvelle Série
            </h5>
        </div>
        <form method="POST" action="{{ route('admin.training.series.store') }}">
            @csrf
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Ex: Série débutant, Série force...">
                            @error('nom')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="consignes" 
                                      id="consignes" 
                                      rows="4"
                                      class="form-control @error('consignes') is-invalid @enderror">{{ old('consignes') }}</textarea>
                            @error('consignes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card-footer d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Créer la série
                </button>
            </div>
        </form>
    </div>
