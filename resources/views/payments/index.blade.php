...
<section class="bg-primary text-white py-5 nataswim-titre">
    <div class="container-lg">
        <div class="row align-items-center">
            
            <div class="col-lg-7 mb-4 mb-lg-0">
                
                <h1 class="display-4 fw-bold mb-3">Passer Premium</h1>
                <p class="lead mb-4">
                    Débloquez l’accès à <strong>tous les contenus exclusifs</strong>.
                </p>

                <h4 class="fw-semibold mb-3">Pourquoi passer en Premium ?</h4>

                <ul class="list-unstyled fs-5">
                    <li class="mb-2">• Accès complet à l’ensemble des pages et dossiers spécialisés</li>
                    <li class="mb-2">• Outils avancés et fonctionnalités exclusives</li>
                    <li class="mb-2">• Support prioritaire et accompagnement </li>
                </ul>
    ...
    <div class="container-lg">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <p class="lead mb-4">
                    Choisissez la durée qui vous convient : 12 / 6 / 3 mois.
                </p>
            </div>
        </div>
...
<!-- Pourquoi Nataswim -->
<section class="py-5 bg-light nataswim-titre">
    <div class="container-lg">
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <article class="card h-100 border-0 shadow-sm">
