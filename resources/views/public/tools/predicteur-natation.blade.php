...
@section('title', 'Prédicteur Performance Natation - Calcul Temps Intermédiaires & Allures')
@section('meta_description', 'Prédicteur performance natation scientifique. Calcul temps intermédiaires, allures, stratégies course. Crawl, papillon, brasse, dos, 4 nages. Formules validées par l\'analyse biomécanique.')
...
<section class="py-5 bg-primary text-white text-center">
    <div class="container py-3">
        <h1 class="display-4 fw-bold d-flex align-items-center justify-content-center gap-3 mb-3">
            Prédicteur de Performance Natation
        </h1>
        <div class="alert alert-info border-0 shadow-sm" 
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="text-dark">
                    <strong>Outil de prédiction avancé :</strong> Estimez vos temps intermédiaires et stratégies de course 
                    avec des formules scientifiques validées par l'analyse biomécanique moderne
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-lg mb-4" style="background: #006170;">
            <div class="card-header text-white text-center py-4 border-0">
                ...
                <p class="mb-0 mt-2 opacity-75">
                    Entrez vos données pour prédire vos temps de course
                </p>
            </div>
            ...
            <div class="card-body p-4" style="background-color: rgba(255, 255, 255, 0.95);">
                ...
                <div class="row g-4">
                    ...
                    <!-- Temps de référence (pour styles normaux) -->
                    <div id="normalStyleInputs" class="col-12">
                        <label for="referenceTime" class="form-label fw-bold text-primary d-flex align-items-center gap-2 mb-3">
                            ...
                            Temps de référence 50m (en secondes)
                        </label>
                    ...
                    <!-- Temps quatre nages (caché par défaut) -->
        ...
        <div id="resultsSection" class="d-none">
            ...
            <div class="card mb-4 shadow-lg">
                <div class="card-header bg-success text-white">
                    <h3 class="mb-2">
                        <i class="fas fa-trophy me-2"></i>Performance Estimée
                    </h3>
                </div>
                <div class="card-body text-center">
                    <div class="alert alert-success border-0 py-4">
                        ...
                        <div>
                            <h4 class="fw-bold text-success mb-0">Temps Total Prédit</h4>
            ...
            <div class="card border-0 shadow-lg mb-4">
                <div class="card-header text-white py-3" style="background: #198754;">
                    <h3 class="h4 mb-0 d-flex align-items-center gap-2">
                        ...
                        Allures et Temps Intermédiaires
                    </h3>
                </div>
...
<section class="py-5">
    <div class="container">
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <h2 class="h4 fw-semibold mb-0 text-primary">
                        Notes Importantes sur les Prédictions
                    </h2>
                </div>
                <div class="row g-3">
                    <div class="col-md-6">
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                ...
                                Formules basées sur l'analyse biomécanique et données de performance élites
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                Progression physiologique constante et endurance adaptée à chaque distance
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                Spécificités biomécaniques intégrées pour chaque style de nage
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                Transitions et spécificités considérées pour le quatre nages
                            </li>
                            <li class="mb-2">
                            ...
                            <li class="mb-2">
                                ...
                                Conditions optimales supposées (bassin 50m, eau 26-28°C)
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="alert alert-info border-0">
                    ...
                    <p class="mb-0">
                        L'analyse biomécanique moderne révèle que l'efficacité propulsive varie de 15-25% entre les styles de nage, 
                        impactant directement les stratégies de course optimales.
                    </p>
                </div>

                <div class="row g-4">
                    <div class="col-md-6">
                        <h6>Facteurs Biomécaniques Clés par Style</h6>
                        <div class="table-responsive">
                            <table class="table table-sm table-striped">
                                <thead class="table-dark">
                                    <tr>
                                        <th>Style</th>
                                        <th>Efficacité Propulsive</th>
                                        <th>Coût Énergétique</th>
                                        <th>Fréquence Optimale</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="small">
                            <li><strong>VO2max spécifique :</strong> Capacité aérobie en natation (±15% vs terrestre)</li>
                            <li><strong>Seuil lactique :</strong> Intensité soutenable sans accumulation</li>
                            <li><strong>Puissance anaérobie :</strong> Sprints et fins de course</li>
                            <li><strong>Économie gestuelle :</strong> Coût énergétique par mètre nagé</li>
                            <li><strong>Flexibilité active :</strong> Amplitude articulaire fonctionnelle</li>
                        </ul>

                        <div class="alert alert-success">
                            <small>
                                <strong>Innovation 2024 :</strong> Les capteurs inertiels sous-marins permettent 
                                une analyse biomécanique précise en conditions réelles de course.
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p class="lead">
                    La <strong>performance en natation</strong> est le résultat d'une interaction complexe entre des facteurs 
                    biomécaniques, physiologiques, psychologiques et environnementaux. L'efficacité du mouvement est primordiale 
                    dans ce milieu résistant qu'est l'eau.
                </p>

                <div class="row g-4">
                    <div class="col-md-6">
                        <h6>L'Impératif de la Technique</h6>
                        <p class="small">
                            Au cœur de toute <strong>performance en natation</strong> réside la <strong>technique de nage</strong>. 
                            Une défaillance technique, même minime, engendre une augmentation significative de la traînée.
                        </p>
                        <ul class="small">
                            <li><strong>Hydrodynamisme :</strong> Position du corps alignée, profilée et stable</li>
                            <li><strong>Propulsion :</strong> Coordination précise bras-jambes-tronc</li>
                            <li><strong>Respiration :</strong> Synchronisation sans perturbation de l'équilibre</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row g-2">
                            <div class="col-12">
                                <div class="card border-success">
                                    <div class="card-body">
                                        <h6 class="card-title small">Capacités Aérobies</h6>
                                        <p class="card-text small">
                                            VO2 max élevée et capacité à maintenir une intensité soutenue sans accumulation excessive de lactate.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card border-warning">
                                    <div class="card-body">
                                        <h6 class="card-title small">Capacités Anaérobies</h6>
                                        <p class="card-text small">
                                            Puissance anaérobie et tolérance au lactate pour les sprints et fins de course.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row g-4 mt-3">
                        ...
                        <div class="card border-primary h-100">
                            ...
                            <div class="card-body">
                                <ul class="small">
                                    ...
                                    <li>Gestion du stress de compétition</li>
                                    <li>Stratégie de course adaptative</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card border-info h-100">
                            ...
                            <div class="card-body">
                                <ul class="small">
                                    <li>Température de l'eau (26-28°C optimal)</li>
                                    <li>Qualité du bassin (turbulences, profondeur)</li>
                                    <li>Conditions de compétition</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card border-success h-100">
                            ...
                            <div class="card-body">
                                <ul class="small">
                                    <li>Données d'entraînement rigoureuses</li>
                                    <li>Évaluation technique régulière</li>
                ...
                <div class="alert alert-success mt-4">
                    ...
                    <p class="mb-0">
                        La performance en natation n'est pas le fruit d'une seule qualité, mais d'une synergie maîtrisée entre 
                        technique irréprochable, condition physique adaptée, préparation mentale solide et approche analytique rigoureuse.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-header bg-success text-white">
                <h3 class="mb-2">
                    ...
                    Stratégies de Course et Optimisation Performance
                </h3>
            </div>
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        <h6>Stratégies de Répartition d'Effort</h6>
                        <div class="table-responsive">
                            <table class="table table-sm table-striped">
                                <thead class="table-dark">
                                    <tr>
                                        <th>Distance</th>
                                        <th>Stratégie Optimale</th>
                                        <th>Répartition</th>
                                        <th>Points Clés</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Even split</td>
                                        <td>25-25-25-25%</td>
                                        <td>Régularité avec finish</td>
                                    </tr>
                                    <tr>
                                        <td>400m+</td>
                                        <td>Progressive</td>
                                        <td>Build-up</td>
                                        <td>Montée progressive, sprint final</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="small">
                            <li><strong>Capteurs inertiels étanches :</strong> Analyse 3D en temps réel</li>
                            <li><strong>Caméras sous-marines HD :</strong> Biomécanique détaillée</li>
                            <li><strong>Lactate portable :</strong> Mesure métabolique instantanée</li>
                            <li><strong>Applications IA :</strong> Correction technique automatisée</li>
                            <li><strong>Wearables aquatiques :</strong> Monitoring cardiaque précis</li>
                        </ul>

                        <h6 class="mt-3">Métriques Clés à Surveiller</h6>
                        <div class="table-responsive">
                            <table class="table table-sm table-striped">
                                <thead class="table-dark">
                                    <tr>
        ...
        <div class="card">
            <div class="card-header bg-secondary text-white">
                <h3 class="mb-2">
                    ...
                    Entraînement et Préparation Moderne
                </h3>
            </div>
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-4">
                        <h6>Périodisation Moderne</h6>
                        <ul class="small">
                            <li><strong>Phase Aérobie (12-16 sem) :</strong> Volume, technique, endurance</li>
                            <li><strong>Phase Mixte (6-8 sem) :</strong> Seuil, résistance lactique</li>
                            <li><strong>Phase Anaérobie (4-6 sem) :</strong> Vitesse, puissance</li>
                            <li><strong>Phase Affûtage (2-3 sem) :</strong> Maintien + récupération</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="small">
                            <li><strong>Sommeil :</strong> 8-9h pour nageurs élites</li>
                            <li><strong>Nutrition :</strong> Hydratation optimale pré/post</li>
                            <li><strong>Thérapies :</strong> Massage, cryothérapie, compression</li>
                            <li><strong>Mobilité :</strong> Étirements spécifiques épaules</li>
                            <li><strong>Mental :</strong> Visualisation, relaxation</li>
                        </ul>

                        <div class="alert alert-warning">
                            <small>
                                <strong>Conseil 2024 :</strong> L'analyse HRV (variabilité cardiaque) 
                                permet un monitoring précis de l'état de récupération quotidien.
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="alert alert-info mt-3">
                    ...
                    <p class="mb-0">
                        Ces prédictions sont des estimations basées sur des modèles scientifiques. Les performances réelles 
...
// Mise à jour des distances selon le style
...
// Calcul spécifique pour le quatre nages
function calculateMedleyPredictions(distance) {
    ...
    keys.forEach((key, index) => {
        ...
        predictions.push({
            ...
            time,
            timeFormatted: formatTime(time),
            label: `${styles[index]} ${index + 1}${index === 0 ? 'er' : 'ème'} ${distance === 400 ? '100m' : '50m'}`
        });
    });
...
function calculatePerformance() {
    ...
    try {
        ...
        if (predictions.length === 0) {
            showError('Aucune prédiction n\'a pu être calculée.');
            return;
        }
        ...
        showError('Une erreur s\'est produite lors du calcul. Veuillez vérifier vos données.');
    }
}
...
function displayResults(predictions, totalTime) {
    ...
    // Remplir le tableau des prédictions
