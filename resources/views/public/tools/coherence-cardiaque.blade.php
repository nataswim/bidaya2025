...
@section('title', 'Simulateur Cohérence Cardiaque - Respiration Guidée Scientifique')
@section('meta_description', 'Simulateur de cohérence cardiaque avec respiration guidée 3-6-5. Outil scientifique validé pour réduire le stress, améliorer la variabilité cardiaque et favoriser le bien-être. Gratuit et sans inscription.')
...
<section class="py-5 text-white text-center" style="background: linear-gradient(135deg, #004f59 0%, #006170 100%);">
    <div class="container py-3">
        ...
        <p class="lead fs-4">Retrouvez votre équilibre intérieur grâce à la respiration guidée scientifique</p>
        ...
        <div id="instructionsAlert" class="alert alert-info border-0 shadow-sm" 
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="text-start text-dark">
                    ...
                    expirez quand il se contracte (vert). Concentrez-vous sur votre respiration et détendez-vous.
                    <br />
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div id="celebrationAlert" class="alert alert-success py-1 px-3 mb-0 d-none">
                    <i class="fas fa-heart me-2"></i>Session terminée !
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="text-center">
                            ...
                            <p class="text-muted">Diminue le cortisol et active le système nerveux parasympathique</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="text-center">
                            <i class="fas fa-heart text-danger mb-3" style="font-size: 2rem;"></i>
                            <h5>Régulation Cardiaque</h5>
                            <p class="text-muted">Améliore la variabilité de la fréquence cardiaque</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="text-center">
                            ...
                            <p class="text-muted">Optimise l'oxygénation et la détente profonde</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">
                    <i class="fas fa-cog me-2"></i>Configuration - Cohérence Cardiaque
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-4">
                    <label class="form-label fw-bold">
                        ...
                        Durée d'expiration (secondes)
                    </label>
                    <select id="expirationSelect" class="form-select form-select-lg">
                        <option value="5000">5 secondes</option>
                        <option value="6000" selected>6 secondes (recommandé)</option>
                ...
                <div class="mb-4">
                    ...
                    <select id="durationSelect" class="form-select form-select-lg">
                        ...
                        <option value="300000" selected>5 minutes (recommandé)</option>
...
<section class="py-5" style="background: linear-gradient(135deg, #004f59 0%, #006170 100%);">
    <div class="container">
        <div class="text-center text-white">
            ...
            <p class="lead fs-4">Pratiquez 3 fois par jour pour des résultats optimaux</p>
...
<section class="py-5">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="lead text-muted">La Cohérence Cardiaque : État des Connaissances 2025</p>
        </div>
                ...
                <article class="card border-0 shadow-lg">
                    ...
                    <div class="card-header text-white py-4" 
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <h1 class="h2 mb-0 text-center">
                                La Cohérence Cardiaque : Fondements Scientifiques et Applications Thérapeutiques
                            </h1>
                        </div>
                        <p class="text-center mb-0 mt-2 opacity-75">État des Connaissances 2025</p>
                    </div>
                    ...
                    <div class="card-body p-5" style="line-height: 1.8;">
                        ...
                        <div class="alert alert-primary border-0 mb-5" style="background: rgba(59, 130, 246, 0.1);">
                            ...
                            <p class="mb-0">
                                La cohérence cardiaque, scientifiquement désignée sous le terme de <strong>"biofeedback de variabilité de la fréquence cardiaque" (HRVB)</strong>, 
                                représente une technique de régulation psychophysiologique basée sur l'optimisation de l'arythmie sinusale respiratoire (ASR). 
                                Les recherches récentes, notamment une méta-analyse de 2024 analysant <strong>1,8 million de sessions utilisateurs</strong>, 
                                confirment l'efficacité de cette approche dans la gestion du stress, de l'anxiété et de diverses pathologies.
                            </p>
                        </div>
                        ...
                        <div class="mb-5">
                                ...
                                <div class="col-md-6">
                                    <div class="card border-0 h-100" style="background: rgba(16, 185, 129, 0.1);">
                                        <div class="card-body p-4">
                                            ...
                                            <p class="mb-0">
                                                La cohérence cardiaque est apparue au tournant des années 2000 dans le cadre des travaux scientifiques 
                                                sur la variabilité de la fréquence cardiaque : alors que la fréquence cardiaque varie de manière chaotique 
                                                habituellement, il est apparu que ces variations deviennent <strong>cohérentes et plus amples</strong> lors 
                                    ...
                                    <div class="card border-0 h-100" style="background: rgba(59, 130, 246, 0.1);">
                                        <div class="card-body p-4">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li><strong class="text-primary">Cohérence cardiaque</strong> : Terme de vulgarisation scientifique</li>
                                                <li><strong class="text-success">HRVB</strong> : Terminologie scientifique officielle</li>
                                                <li><strong class="text-warning">ASR</strong> : Phénomène physiologique sous-jacent</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="alert alert-info border-0">
                                <p class="mb-0">
                                    ...
                                    L'expression « cohérence cardiaque » est plutôt à destination du public, tandis que l'expression retenue par les scientifiques est 
                                    <strong> « biofeedback de variabilité de la fréquence cardiaque »</strong>, en anglais : « Heart Rate Variability Biofeedback » ou HRVB.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            <h2 class="text-primary mb-4 h3">
                                ...
                                Bases Physiologiques et Mécanismes
                            </h2>

                            <div class="mb-4">
                                <h4 class="text-success h5 mb-3">2.1 L'Arythmie Sinusale Respiratoire (ASR)</h4>
                                <p class="mb-3">
                                    Ce phénomène est appelé « arythmie sinusale respiratoire » (ASR) dans le monde biomédical, ou « cohérence cardiaque » par le grand public. 
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="card border-0 text-center p-3" style="background: rgba(59, 130, 246, 0.1);">
                                            ...
                                            <p class="small mb-0">Augmentation de la fréquence cardiaque<br/>(diminution du tonus vagal)</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card border-0 text-center p-3" style="background: rgba(16, 185, 129, 0.1);">
                                            ...
                                            <p class="small mb-0">Diminution de la fréquence cardiaque<br/>(activation parasympathique)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body text-center p-3">
                                        <div class="row g-3">
                                            <div class="col-4">
                                                ...
                                                <p class="small mb-0">séances par jour</p>
                                            </div>
                                            <div class="col-4">
                                                <div class="bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2" 
                                                     style="width: 50px; height: 50px;">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <p class="small mb-0">minutes par séance</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card border-0 h-100 shadow-sm text-center">
                                        <div class="card-body p-4">
                                            ...
                                            <h6 class="fw-bold">Stress & Anxiété</h6>
                                            <p class="text-muted small mb-2">Effet important confirmé</p>
                                            <span class="badge bg-success">Méta-analyse 2017</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="card border-0 h-100 shadow-sm text-center">
                                        <div class="card-body p-4">
                                            ...
                                            <h6 class="fw-bold">Dépression</h6>
                                            <p class="text-muted small mb-2">Effet modéré sur 794 participants</p>
                                            <span class="badge bg-primary">14 études (2021)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="card border-0 h-100 shadow-sm text-center">
                                        <div class="card-body p-4">
                                            ...
                                            <h6 class="fw-bold">Études Analysées</h6>
                                            <p class="text-muted small mb-2">Méta-analyse globale</p>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card border-0 h-100 shadow-sm text-center">
                                        <div class="card-body p-4">
                                            ...
                                            <h6 class="fw-bold">Sessions Analysées</h6>
                                            <p class="text-muted small mb-2">Plus grande étude jamais réalisée</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 h-100" style="background: rgba(220, 53, 69, 0.1);">
                                        <div class="card-body p-4">
                                            ...
                                            <p class="mb-3">
                                                Cette technique a fait son entrée dans les services hospitaliers, en particulier ceux dédiés à la réadaptation cardiaque, 
                                                car les études ont objectivé ses bénéfices dont la <strong>réduction des récidives d'infarctus</strong>.
                                            </p>
                                            <div class="list-group list-group-flush">
                                                <div class="list-group-item border-0 px-0 py-2">✓ Réadaptation post-infarctus</div>
                                                <div class="list-group-item border-0 px-0 py-2">✓ Prévention des récidives cardiovasculaires</div>
                                                <div class="list-group-item border-0 px-0 py-2">✓ Amélioration de la variabilité cardiaque</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 h-100" style="background: rgba(255, 193, 7, 0.1);">
                                        <div class="card-body p-4">
                                            ...
                                            <p class="mb-3">
                                                Cette technique peut être utilisée pour toutes les formes d'anxiété et particulièrement les formes avec une activation 
                                                du système sympathique comme les <strong>paniques, le stress, le syndrome de stress post-traumatique</strong>.
                                            </p>
                                            <div class="alert alert-warning border-0 py-2 px-3">
                                                <small>
                                                    <strong>Spécialité :</strong> Forte expression cardio-respiratoire des troubles anxieux
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="alert alert-success border-0 mb-4" style="background: rgba(16, 185, 129, 0.1);">
                                <h5 class="text-success mb-3">5.2 Effets Hormonaux Documentés</h5>
                                <div class="row g-4">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="mb-2">
                                                <span class="badge bg-danger me-2">Anxiété</span>
                                                Via dopamine et sérotonine
                                            </li>
                                            <li class="mb-2">
                                                <span class="badge bg-danger me-2">Dépression</span>
                                                Amélioration des neurotransmetteurs
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="card border-0 h-100" style="background: rgba(16, 185, 129, 0.1);">
                                        <div class="card-body p-4">
                                            <h5 class="text-success mb-3">6.1 Indications Validées</h5>
                                            
                                            <div class="mb-3">
                                                <h6 class="text-success">Niveau de preuve élevé :</h6>
                                                <ul class="list-unstyled small">
                                                    <li>• Gestion du stress et de l'anxiété</li>
                                                    <li>• Réadaptation cardiovasculaire</li>
                                            ...
                                            <div>
                                                <h6 class="text-warning">Niveau de preuve modéré :</h6>
                                                <ul class="list-unstyled small">
                                                    <li>• Dépression (en complément)</li>
                                                    <li>• Stress post-traumatique</li>
                                                    <li>• Troubles du sommeil liés au stress</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 h-100" style="background: rgba(220, 53, 69, 0.1);">
                                        <div class="card-body p-4">
                                            <h5 class="text-danger mb-3">6.2 Précautions Importantes</h5>
                                            
                                            <div class="alert alert-danger border-0 py-2 mb-3">
                                                <h6 class="text-danger mb-2">Recommandations :</h6>
                                                <ul class="list-unstyled small mb-0">
                                                    <li>• Ne pas remplacer un traitement médical</li>
                                                    <li>• Supervision professionnelle pour pathologies graves</li>
                                                    <li>• Adaptation selon l'âge et les capacités</li>
                                                    <li>• Technique complémentaire, non substitutive</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="alert alert-primary border-0 mb-4" style="background: rgba(59, 130, 246, 0.1);">
                                <h5 class="text-primary mb-3">Synthèse Scientifique</h5>
                                <p class="mb-3">
                                    La cohérence cardiaque, basée sur l'optimisation de l'arythmie sinusale respiratoire, représente une 
                                    <strong> approche thérapeutique non-invasive</strong> dont l'efficacité est soutenue par des preuves scientifiques croissantes. 
                                    Les méta-analyses récentes confirment son utilité dans la gestion du stress, de l'anxiété et de diverses pathologies cardiovasculaires et psychiatriques.
                                </p>
                                <p class="mb-0">
                                    La cohérence cardiaque s'impose ainsi comme un <strong>outil thérapeutique complémentaire précieux</strong>, 
                                    à condition d'être utilisée dans un cadre scientifique rigoureux et en complément d'une prise en charge appropriée.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="border-top pt-4">
                            <h5 class="text-muted mb-3">Références Bibliographiques</h5>
                            <div class="row g-3 small text-muted">
                                <div class="col-md-6">
                                    <p class="mb-1">• <strong>Inserm</strong> (2023) - "La cohérence cardiaque, une technique pour améliorer sa santé, vraiment ?" Canal Détox</p>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1">• <strong>Université de Lausanne</strong> (2025) - "La cohérence cardiaque, une réalité physiologique?"</p>
                                </div>
                            </div>
                            <p class="small text-muted mt-3 mb-0">
                                <em>Note : Cet article reflète l'état des connaissances scientifiques en février 2025. 
                                Les recherches dans ce domaine évoluant rapidement, il est recommandé de consulter les publications les plus récentes.</em>
                            </p>
                        </div>
...
class HeartCoherenceSimulator {
    ...
    initializeElements() {
        ...
        // Masquer/afficher les vibrations selon la compatibilité
    ...
    setupEventListeners() {
        ...
        // Événements pour les raccourcis
    ...
    updateDisplay() {
        ...
        // Informations cycle
        this.elements.cycleInfo.textContent = `Cycle ${this.completedCycles} / ${this.totalCycles} • ${Math.round(progress)}% terminé`;
    ...
    updateStatus() {
        if (this.isRunning) {
            ...
            this.elements.statusBadge.textContent = 'Terminé';
            this.elements.statusBadge.className = 'badge fs-6 px-3 py-2 bg-warning text-dark';
            this.elements.toggleBtn.innerHTML = '<i class="fas fa-check me-2"></i>Terminé';
    ...
    start() {
        ...
        this.cycleInterval = setInterval(() => {
            ...
            // Déclencher sons et vibrations lors des changements de phase
...
function saveSettings() {
    ...
    simulator.reset(); // Appliquer les nouveaux paramètres
