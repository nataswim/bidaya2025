...
/**
 * 🇬🇧 Seeder for base workouts B-001 to B-025
 * 🇫🇷 Seeder pour les workouts base B-001 à B-025
 */
class WorkoutBaseSeeder extends Seeder
{
    public function run(): void
    {
        $categoryId = 10; // Catégorie Base
        ...
        $this->command->info("Création des workouts Base B-001 à B-025...");
        ...
        try {
            for ($i = 1; $i <= 25; $i++) {
                ...
                $title = "Séance Base : -B-{$number}-";
                $slug = "seance-b{$number}";
            ...
            $this->command->info("✅ 25 workouts Base créés avec succès !");
