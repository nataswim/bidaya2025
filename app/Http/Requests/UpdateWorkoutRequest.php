...
/**
 * 🇬🇧 UpdateWorkoutRequest - Validation for updating a workout
 * 🇫🇷 UpdateWorkoutRequest - Validation pour mettre à jour un workout
 * 
 * @file app/Http/Requests/UpdateWorkoutRequest.php
 */
class UpdateWorkoutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'nullable|string|max:191|unique:workouts,slug,' . $this->workout->id,
