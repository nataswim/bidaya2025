...
/**
 * 🇬🇧 StoreCatalogueModuleRequest - Validation for creating a catalogue module
 * 🇫🇷 StoreCatalogueModuleRequest - Validation pour créer un module de catalogue
 * 
 * @file app/Http/Requests/StoreCatalogueModuleRequest.php
 */
class StoreCatalogueModuleRequest extends FormRequest
{
