...
/**
 * Validation pour la mise à jour d'une vidéo
 * 
 * @file app/Http/Requests/UpdateVideoRequest.php
 */
class UpdateVideoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->input('type') === 'upload') {
            ...
            // Sinon, fichier optionnel lors de l'édition (pour remplacer l'ancien)
            else {
                $rules['file'] = 'nullable|file|mimes:mp4,webm,mov,avi,mkv,flv,wmv,mpeg,mpg,3gp|max:512000'; // 500MB
            }
        } 
