...
/**
 * 🇬🇧 StoreCatalogueUnitRequest - Validation for creating a catalogue unit
 * 🇫🇷 StoreCatalogueUnitRequest - Validation pour créer une unité de catalogue
 * 
 * @file app/Http/Requests/StoreCatalogueUnitRequest.php
 */
class StoreCatalogueUnitRequest extends FormRequest
{
